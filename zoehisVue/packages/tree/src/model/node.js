...
import { markNodeData, NODE_KEY, objectAssign } from './util';
...
export default class Node {
  ...
  updateLeafState() {
    let noleaf = this.store.props.noleaf;
    if (noleaf !== '' && typeof this.data[noleaf] !== 'undefined' && this.data[noleaf] !== '' && this.data[noleaf] !== false ){
      this.isLeaf = false;
      return
    }
    if (this.store.lazy === true && !this.data[noleaf] && typeof this.data[noleaf] !== 'undefined'){
      this.isLeaf = true;
      return
    }
